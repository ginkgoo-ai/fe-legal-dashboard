  ...
  return (
    <div className="w-full">
      <div className="w-full grid grid-cols-2 items-center gap-4">
        <div className="rounded-lg border-dashed border-[#D8DFF5] border p-4 flex justify-start items-center gap-5 overflow-hidden">
        ...
        <div className="rounded-lg border-dashed border-[#D8DFF5] border p-4 flex justify-between items-center gap-5 overflow-hidden">
